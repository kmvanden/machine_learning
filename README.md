...
**L1 and L2 regularization (elastic net)**: combines the penalties of L1 and L2 regularization. The combination of L1 and L2 penalties makes elastic net more stable with high dimensional and highly correlated data.
