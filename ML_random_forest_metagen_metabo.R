...
ggplot(feature_split_summary[1:20, ], aes(x = reorder(Feature, n_models), y = n_models)) +
  geom_col(fill = "steelblue") + coord_flip() + theme_minimal() +
  labs(title = "Top 20 most frequently selected features - model",
       x = "Feature", y = "Number of models")

# average number of times feature was used in a split per tree (across all models) 
ggplot(feature_split_summary[1:20, ], aes(x = reorder(Feature, avg_per_tree), y = avg_per_tree)) +
  geom_col(fill = "steelblue") + coord_flip() + theme_minimal() +
  labs(title = "Top 20 most frequently selected features - split",
       x = "Feature", y = "Average splits per tree")
...
#   [1] grid      tools     stats4    splines   compiler  parallel  stats     graphics  grDevices utils    
# [11] datasets  methods   base     
# 
# other attached packages:
#   [1] MASS_7.3-65                   hardhat_1.4.2                 lifecycle_1.0.4              
# [4] farver_2.1.2                  digest_0.6.39                 rstatix_0.7.3                
# [7] DEoptimR_1.1-4                gtable_0.3.6                  lava_1.8.2                   
# [10] cli_3.6.5                     Formula_1.2-5                 ipred_0.9-15                 
# [13] ggsignif_0.6.4                gower_1.0.2                   ModelMetrics_1.2.2.2         
# [16] data.table_1.17.8             robustbase_0.99-6             glue_1.8.0                   
# [19] class_7.3-23                  globals_0.18.0                scales_1.4.0                 
# [22] hms_1.1.4                     dbscan_1.2.4                  generics_0.1.4               
# [25] checkmate_2.3.3               tensorA_0.36.2.1              ggpubr_0.6.2                 
# [28] pillar_1.11.1                 proxy_0.4-28                  bayesm_3.1-7                 
# [31] survival_3.8-3                S7_0.2.1                      withr_3.0.2                  
# [34] plyr_1.8.9                    listenv_0.10.0                codetools_0.2-20             
